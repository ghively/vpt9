...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1292.642822, 628.0, 36.0, 22.0 ],
					"presentation_rect" : [ 1295.25, 627.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1615.5, 613.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1116.0, 640.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1357.25, 615.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1197.0, 145.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "s rate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1619.5, 708.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "s #1both"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1274.772705, 646.0, 24.0, 22.0 ],
					"style" : "",
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 19.5, 9.0, 21.0, 15.0 ],
					"style" : "",
					"text" : "v"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 27,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 907.0, 556.0, 699.0, 35.0 ],
					"style" : "",
					"text" : "OSC-route /clip /clipnr /rate /loop /xfade /resolution /trig /on /vol /loopreport /last /random /scrub /start /stop /in /out /loopreset /pan /playlist /play /soc /cliptime /com /alpha /viddll"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 563.0, 349.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "line 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 462.0, 387.0, 33.0, 22.0 ],
									"style" : "",
									"text" : "stop"
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 388.5, 529.0, 482.0, 22.0 ],
					"style" : "",
					"text" : "jit.movie @output_texture 1 @engine viddll @drawto vpt @autostart 1 @colormode uyuv"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-14",
					"items" : [ "OFF", ",", "apple-04.jpg", ",", "black.mov", ",", "chess.jpg", ",", "maja.mov", ",", "maninpark.mov", ",", "petanque.mov", ",", "prisme.mov", ",", "SampleHap.mov", ",", "strawberry-05.jpg", ",", "tapet.jpg", ",", "tekst.jpg", ",", "vpt07.png", ",", "xlive101.mov" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"pattrmode" : 1,
					"prefix" : "HD:/Users/hcg/lab/vpt7-2017-osx-beta03/defaultproject2017/video/",
					"prefix_mode" : 2,
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 65.0, 553.5, 482.0, 22.0 ],
					"style" : "",
					"text" : "jit.movie @output_texture 1 @engine viddll @drawto vpt @autostart 1 @colormode uyuv"
				}
